...
begin
  ...
  if ((ADOTabCxAFCXSTATUS.AsString <> 'A') and (ADOTabCxAFCXBLQ.AsString = 'N') and
    ...
    MessageDlg('Caixa encontra-se aberto para esta database ou database é inválida.',mtWarning,mbOKCancel,0);
  end;
end;
...
begin
  ...
  if ((ADOTabCxAFCXSTATUS.AsString <> 'F') and (ADOTabCxAFCXBLQ.AsString = 'N') and
    ...
    MessageDlg('Caixa encontra-se fechado para esta database ou database é inválida.',mtWarning,mbOKCancel,0);
  end;
end;
